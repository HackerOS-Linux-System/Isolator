...
func main() {
	...
	var rootCmd = &cobra.Command{
		Use:           "isolated",
		Short:         "Podman-based package manager — every package in its own isolated container, always (a variant of isolator; see 'isolated docs')",
		Version:       src.Version,
		SilenceUsage:  true,
		SilenceErrors: true,
	...
	rootCmd.SetVersionTemplate("isolated {{.Version}}\n")

	installCmd := &cobra.Command{
		Use:   "install <pkg>",
		Short: "Install a package into its own isolated container (always — that's the only mode this tool has)",
